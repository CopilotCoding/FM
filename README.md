...
PROJECT_STATUS: "PROJECT IS A FAILURE TO LEARN FROM: STILL HAS SAME SONG PRODUCTION ISSUE, WORKING ON PATCH NOW AS NAIVE SEED APPROACH FAILED, PARTIALLY FIXED"
